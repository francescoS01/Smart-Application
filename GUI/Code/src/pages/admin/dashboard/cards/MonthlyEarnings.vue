<template>
  <VaCard>
    <VaCardTitle>
      <h1 class="card-title text-tag text-secondary font-bold uppercase mb-4" style="font-size: 0.9rem; color: black;">Average power consumption all machines</h1>
    </VaCardTitle>
    <VaCardContent>
    ...
    y: {
      ...
      ticks: {
        ...
        callback: function (value) {
          return `${value} (kWh)`; // Formattazione dei valori Y
        },
      }
    },
  },
