...
const KPI_3_data = computed(() => store.getKPI_3.values)
const KPI_3_unit = computed(() => store.getKPI_3.unit || '')
const chartData = useChartData2(KPI_3_data)
    ...
    tooltip: {
      ...
      callbacks: {
        ...
        label: (tooltipItem) => {
          ...
          return `Value: ${value} (${KPI_3_unit.value})`
        },
      },
    },
  },
