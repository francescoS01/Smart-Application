...
const KPI_2_data = computed(() => store.getKPI_2.values)
const KPI_2_unit = computed(() => store.getKPI_2.unit || '')
const chartData = useChartData2(KPI_2_data)
    ...
    tooltip: {
      ...
      callbacks: {
        ...
        label: (tooltipItem) => {
          ...
          return `Value: ${value} (${KPI_2_unit.value || ''})`
        },
      },
    },
  },
