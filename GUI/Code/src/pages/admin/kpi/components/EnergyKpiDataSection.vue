...
const KPI_2_data = computed(() => store.getKPI_2)

const dashboardMetrics = computed<DashboardMetric[]>(() => [
  {
    id: 'openInvoices',
    title: 'Average day',
    value: `${KPI_2_data.value.averageDay} (${KPI_2_data.value.unit || ''})`,
    icon: 'info',
    changeText: '',
    changeDirection: '',
  ...
  },  
  {
    id: 'openInvoices',
    title: 'Average week',
    value: `${KPI_2_data.value.averageWeek} (${KPI_2_data.value.unit || ''})`,
    icon: 'info',
    changeText: '',
    changeDirection: '',
    iconBackground: getColor('info'),
  ...
  },
  {
    id: 'openInvoices',
    title: 'Average Month',
    value: `${KPI_2_data.value.averageMonth} (${KPI_2_data.value.unit || ''})`,
    icon: 'info',
    changeText: '',
    changeDirection: '',
    iconBackground: getColor('info'),
