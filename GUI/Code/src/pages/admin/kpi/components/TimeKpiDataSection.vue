...
const KPI_1_data = computed(() => store.getKPI_1)

const dashboardMetrics = computed<DashboardMetric[]>(() => [
  {
    id: 'openInvoices',
    title: 'Average day',
    value: `${KPI_1_data.value.averageDay} (${KPI_1_data.value.unit || ''})`,
    icon: 'info',
    changeText: '',
    changeDirection: '',
  ...
  },  
  {
    id: 'openInvoices',
    title: 'Average week',
    value: `${KPI_1_data.value.averageWeek} (${KPI_1_data.value.unit || ''})`,
    icon: 'info',
    changeText: '',
    changeDirection: '',
    iconBackground: getColor('info'),
  ...
  },
  {
    id: 'openInvoices',
    title: 'Average Month',
    value: `${KPI_1_data.value.averageMonth} (${KPI_1_data.value.unit || ''})`,
    icon: 'info',
    changeText: '',
    changeDirection: '',
    iconBackground: getColor('info'),
